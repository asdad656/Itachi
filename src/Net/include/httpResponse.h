 ...
 * @Author: lqf
 * @page: www.Jackey.top
 * @Date: 2022-02-08 21:56:30
 * @LastEditors: lqf
 * @LastEditTime: 2022-02-09 13:08:56
 * @Description: 
 */
...
namespace http{
    ...
    enum HttpStatus{
        #define HTTP_STATUS_ENUM_DEFINER(value,name,describe)    \
            name=value,

        HTTP_STATUS_MAP(HTTP_STATUS_ENUM_DEFINER)    
        HTTP_INVAILD_STATUS
    };
