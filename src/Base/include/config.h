 ...
 * @LastEditors: lqf
 * @LastEditTime: 2022-03-12 12:50:30
...
namespace Itachi
{
    ...
    public:
        ...
        ConfigVarBase(const std::string &name, const std::string &describtion = "none") : m_name(name),
    ...
    */
    ...
    template <>
    class lexical_cast<std::string, std::string>
    {
    public:
    ...
    public:
        ...
        ConfigVar(const std::string &name, const T &default_value,
                  const std::string &describtion = "") : ConfigVarBase(name, describtion),
                                                         m_var(default_value)
        {
            init();
        }
